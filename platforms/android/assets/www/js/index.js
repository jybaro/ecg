...
var app = {
    info: {
        ...
        //remoteDB_url: 'http://localhost:5984/ecg',
        remoteDB_url: 'http://104.131.40.56:5984/ecg',
    ...
    onDeviceReady: function() {
        if (!window.inicializado) {
            ...
            */
            ...
            p_('enojado').onclick = function() {
                //Obtención de documento a partir del formulario:
                var doc = p_generar_doc('enojado');
            ...
            p_('serio').onclick = function() {
                //Obtención de documento a partir del formulario:
                var doc = p_generar_doc('serio');
            ...
            p_('feliz').onclick = function() {
                //Obtención de documento a partir del formulario:
                var doc = p_generar_doc('feliz');
...
{"_id":"usuario|1713174041","rol":"operador","cedula":"1713174041","clave":"1713174041","nombre":"Pablo Toapanta","telefono":"2798291","celular":"0984404988","email":"pablo_vtn@hotmail.com","indice_apellidosnombres":"|usuario|toapantapablo"}
    ]);
    return;
*/    
...
function p_generar_doc(emocion) {
    var doc;
